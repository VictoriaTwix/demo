...
public class ClientCabin {
    ...
    private void handleImageClicked(MouseEvent event) {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("ClientProfile.fxml"));
            Scene scene = new Scene(fxmlLoader.load(), 523, 423);
